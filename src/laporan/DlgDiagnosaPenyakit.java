...
public class DlgDiagnosaPenyakit extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        BtnPrint.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/kemkes.png"))); // NOI18N
        BtnPrint.setMnemonic('T');
        BtnPrint.setText("IDRG");
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        // Buka dialog DlgListKlaim dari package integration_idrg
        DlgListKlaim listKlaim = new DlgListKlaim((Frame) this.getParent(), true);
        listKlaim.setSize(internalFrame1.getWidth() - 20, internalFrame1.getHeight() - 20);
        listKlaim.setLocationRelativeTo(internalFrame1);
        listKlaim.setVisible(true);
