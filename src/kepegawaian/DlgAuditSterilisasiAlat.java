...
public final class DlgAuditSterilisasiAlat extends javax.swing.JDialog {
    ...
    private double audit1=0,audit2=0,audit3=0,audit4=0,audit5=0,audit6=0,audit7=0,audit8=0,audit9=0,audit10=0,audit11=0,pembagi=0,
                   naaudit1=0,naaudit2=0,naaudit3=0,naaudit4=0,naaudit5=0,naaudit6=0,naaudit7=0,naaudit8=0,naaudit9=0,naaudit10=0,naaudit11=0,
                   ttlaudit1=0,ttlaudit2=0,ttlaudit3=0,ttlaudit4=0,ttlaudit5=0,ttlaudit6=0,ttlaudit7=0,ttlaudit8=0,ttlaudit9=0,ttlaudit10=0,ttlaudit11=0,ttlpenilaian=0;
    ...
    private void initComponents() {
        ...
        Audit10.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Ya", "Tidak", "NA" }));
        ...
        Audit11.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Ya", "Tidak", "NA" }));
    ...
    private void tampil() {
        ...
        try{
            ...
            try {
                ...
                i=1;
                while(rs.next()){
                    pembagi=0;audit1=0;audit2=0;audit3=0;audit4=0;audit5=0;audit6=0;audit7=0;audit8=0;audit9=0;audit10=0;audit11=0;
                    ...
                    if(!rs.getString("audit10").equals("NA")){
                    ...
                    if(!rs.getString("audit11").equals("NA")){
                    ...
                    ttlpenilaian=ttlpenilaian+(((audit1+audit2+audit3+audit4+audit5+audit6+audit7+audit8+audit9+audit10+audit11)/pembagi)*100);
                    tabMode.addRow(new Object[]{
                        rs.getString("tanggal"),rs.getString("id_ruang"),rs.getString("nama_ruang"),rs.getString("audit1"),rs.getString("audit2"),rs.getString("audit3"),rs.getString("audit4"),
                        rs.getString("audit5"),rs.getString("audit6"),rs.getString("audit7"),rs.getString("audit8"),rs.getString("audit9"),rs.getString("audit10"),rs.getString("audit11"),
                        Math.round(((audit1+audit2+audit3+audit4+audit5+audit6+audit7+audit8+audit9+audit10+audit11)/pembagi)*100)+" %"
                    });
                    i++;
                }
                i=i-1;
                if(i>0){
                    tabMode.addRow(new Object[]{
                        "","NA",":",""+naaudit1,""+naaudit2,""+naaudit3,""+naaudit4,""+naaudit5,""+naaudit6,""+naaudit7,""+naaudit8,""+naaudit9,""+naaudit10,""+naaudit11,
                        ""+(naaudit1+naaudit2+naaudit3+naaudit4+naaudit5+naaudit6+naaudit7+naaudit8+naaudit9+naaudit10+naaudit11)
                    });
                    tabMode.addRow(new Object[]{
                        "","Ya",":",""+ttlaudit1,""+ttlaudit2,""+ttlaudit3,""+ttlaudit4,""+ttlaudit5,""+ttlaudit6,""+ttlaudit7,""+ttlaudit8,""+ttlaudit9,""+ttlaudit10,""+ttlaudit11,
                        ""+(ttlaudit1+ttlaudit2+ttlaudit3+ttlaudit4+ttlaudit5+ttlaudit6+ttlaudit7+ttlaudit8+ttlaudit9+ttlaudit10+ttlaudit11)
                    });
                    tabMode.addRow(new Object[]{
                        ...
                        ""+(i-ttlaudit7-naaudit7),""+(i-ttlaudit8-naaudit8),""+(i-ttlaudit9-naaudit9),""+(i-ttlaudit10-naaudit10),""+(i-ttlaudit11-naaudit11),
                    ...
                    tabMode.addRow(new Object[]{
                        ...
                        Math.round((ttlaudit10/(i-naaudit10))*100)+" %",Math.round((ttlaudit11/(i-naaudit11))*100)+" %",Math.round(ttlpenilaian/i)+" %"
                    });
                }
            } catch (Exception e) {
