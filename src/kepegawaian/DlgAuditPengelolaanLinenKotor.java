...
public final class DlgAuditPengelolaanLinenKotor extends javax.swing.JDialog {
    ...
    private double audit1=0,audit2=0,audit3=0,audit4=0,audit5=0,audit6=0,audit7=0,audit8=0,
                naaudit1=0,naaudit2=0,naaudit3=0,naaudit4=0,naaudit5=0,naaudit6=0,naaudit7=0,naaudit8=0,
                ttlaudit1=0,ttlaudit2=0,ttlaudit3=0,ttlaudit4=0,ttlaudit5=0,ttlaudit6=0,ttlaudit7=0,ttlaudit8=0,
                pembagi=0,ttlpenilaian=0;
    ...
    private void tampil() {
        ...
        try{
            ...
            try {
                ...
                i=1;
                while(rs.next()){
                    pembagi=0;audit1=0;audit2=0;audit3=0;audit4=0;audit5=0;audit6=0;audit7=0;audit8=0;
                    ...
                    tabMode.addRow(new Object[]{
                        ...
                        rs.getString("audit3"),rs.getString("audit4"),rs.getString("audit5"),rs.getString("audit6"),rs.getString("audit7"),
                        rs.getString("audit8"),Math.round(((audit1+audit2+audit3+audit4+audit5+audit6+audit7+audit8)/pembagi)*100)+" %"
                    });
                    i++;
                }
                i=i-1;
