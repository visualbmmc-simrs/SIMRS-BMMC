...
public final class AplicareCekReferensiKamar extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        BtnUpdate.setToolTipText("Alt+U - Simpan ke database lokal");
    ...
    private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
        if(evt.getKeyCode()==KeyEvent.VK_SPACE){
            ...
            Valid.pindah(evt,Kelas,BtnUpdate);
        }
    }//GEN-LAST:event_BtnCariKeyPressed

    private void BtnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnUpdateActionPerformed
        if(tabMode.getRowCount()==0){
            JOptionPane.showMessageDialog(null,"Maaf, data kosong. Tidak ada data yang bisa disimpan...!!!!");
            return;
        }
        
        int konfirmasi = JOptionPane.showConfirmDialog(null,"Seluruh data lama di database lokal akan dihapus dan disesuaikan dengan data di tabel.\nApakah Anda yakin ingin melanjutkan?","Konfirmasi Update",JOptionPane.YES_NO_OPTION);
        if(konfirmasi == JOptionPane.YES_OPTION){
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            int berhasil = 0;
            int gagal = 0;
            try {
                // Hapus semua data lama di database lokal
                Sequel.queryu("DELETE FROM kelas_kamar_aplicare");
                
                // Insert ulang semua data dari tabel GUI
                ...
                if(gagal == 0){
                    JOptionPane.showMessageDialog(null,"Berhasil menyimpan "+berhasil+" data ke database lokal.");
                } else {
                    JOptionPane.showMessageDialog(null,"Proses selesai dengan beberapa error.\nBerhasil: "+berhasil+" data\nGagal: "+gagal+" data");
                }
            } catch (Exception ex) {
