...
public final class ApotekBPJSInputResepObat extends javax.swing.JDialog {
    ...
    private boolean wajibMapping = false;
    ...
    private DlgCariPeriksaLab hasillab;
    private ApotekBPJSKunjunganSEP apotekSEP;
    private String kodedokterregis = "";
    private String namadokterregis = "";
    ...
    private void initComponents() {
        ...
        btnDetailSEP1 = new javax.swing.JButton();
        btnSEPResume = new javax.swing.JButton();
        ...
        DTPTgl.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "22-07-2026" }));
        ...
        jLabel19.setText("Hasil Lab :");
        jLabel19.setName("jLabel19"); // NOI18N
        FormInput.add(jLabel19);
        jLabel19.setBounds(750, 120, 80, 23);
        ...
        icon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/icon bpjs.png"))); // NOI18N
        icon.setName("icon"); // NOI18N
        FormInput.add(icon);
        icon.setBounds(710, 10, 30, 23);

        jLabel21.setText("Tanggal SEP :");
        jLabel21.setName("jLabel21"); // NOI18N
        FormInput.add(jLabel21);
        jLabel21.setBounds(243, 40, 80, 23);

        jLabel22.setText("Lihat SEP :");
        jLabel22.setName("jLabel22"); // NOI18N
        FormInput.add(jLabel22);
        jLabel22.setBounds(750, 70, 80, 23);

        btnHasilLab.setBackground(new java.awt.Color(255, 255, 255));
        btnHasilLab.setForeground(new java.awt.Color(102, 102, 102));
        ...
        btnHasilLab.setBounds(750, 140, 90, 23);

        btnDetailSEP1.setBackground(new java.awt.Color(255, 255, 255));
        btnDetailSEP1.setForeground(new java.awt.Color(51, 51, 51));
        btnDetailSEP1.setText("Detail SEP");
        btnDetailSEP1.setName("btnDetailSEP1"); // NOI18N
        btnDetailSEP1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnDetailSEP1ActionPerformed(evt);
            }
        });
        FormInput.add(btnDetailSEP1);
        btnDetailSEP1.setBounds(740, 10, 100, 23);

        btnSEPResume.setBackground(new java.awt.Color(255, 255, 255));
        btnSEPResume.setForeground(new java.awt.Color(102, 102, 102));
        ...
        FormInput.add(btnSEPResume);
        btnSEPResume.setBounds(750, 90, 90, 23);

        jLabel9.setText("Pelayanan :");
        jLabel9.setName("jLabel9"); // NOI18N
        jLabel9.setPreferredSize(new java.awt.Dimension(68, 23));
        FormInput.add(jLabel9);
        jLabel9.setBounds(330, 100, 70, 23);
        ...
        jCheckBox1.setBounds(820, 40, 20, 20);
    ...
    private void jCheckBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckBox1ActionPerformed
        wajibMapping = jCheckBox1.isSelected();
                ...
                if (reply == JOptionPane.YES_OPTION) {
                    ...
                    if (sukses == true) {
                        try {
                            ...
                            if (nameNode.path("code").asText().equals("200")) {
                                ...
                                // ============================================================
                                // HEADER RESEP - LANGSUNG SIMPAN (TIDAK PEDULI SUKSES/GAGAL)
                                // ============================================================
                                Sequel.menyimpantf2("bridging_resep_apotek_bpjs", "?,?,?,?,?,?,?,?,?,?", "Data Apotek Online", 10, new String[]{
                                ...
                                for (i = 0; i < tbObat.getRowCount(); i++) {
                                    if (Valid.SetAngka(tbObat.getValueAt(i, 0).toString()) > 0) {
                                        try {
                                            ...
                                            // ============================================================
                                            // OBAT NON RACIKAN - CEK WAJIB MAPPING
                                            // ============================================================
                                            if (wajibMapping) {
                                                if (nameNode.path("code").asText().equals("200")) {
                                                ...
                                                // LANGSUNG SIMPAN, TIDAK PEDULI GAGAL
                                                Sequel.menyimpantf("bridging_resep_apotek_bpjs_nonracikan", "?,?,?,?,?,?,?", "Obat Non Racikan BPJS", 7, new String[]{
                                                    response.path("noApotik").asText(), NoResep.getText(), tbObat.getValueAt(i, 1).toString(), tbObat.getValueAt(i, 3).toString(), tbObat.getValueAt(i, 4).toString(), tbObat.getValueAt(i, 0).toString(), tbObat.getValueAt(i, 5).toString()
                                                });
                                            }
                                        } catch (Exception ex) {
                                ...
                                for (i = 0; i < tbDetailObatRacikan.getRowCount(); i++) {
                                    if (Valid.SetAngka(tbDetailObatRacikan.getValueAt(i, 1).toString()) > 0) {
                                        try {
                                            ...
                                            // ============================================================
                                            // OBAT RACIKAN - CEK WAJIB MAPPING
                                            // ============================================================
                                            if (wajibMapping) {
                                                if (nameNode.path("code").asText().equals("200")) {
                                                ...
                                                // LANGSUNG SIMPAN, TIDAK PEDULI GAGAL
                                                Sequel.menyimpantf("bridging_resep_apotek_bpjs_racikan", "?,?,?,?,?,?,?,?,?", "Obat Racikan", 9, new String[]{
                                                    response.path("noApotik").asText(), (tbDetailObatRacikan.getValueAt(i, 0).toString().length() == 1 ? "R.0" + tbDetailObatRacikan.getValueAt(i, 0).toString() : "R." + tbDetailObatRacikan.getValueAt(i, 0).toString()), NoResep.getText(),
                                                    tbDetailObatRacikan.getValueAt(i, 2).toString(), tbDetailObatRacikan.getValueAt(i, 4).toString(), tbDetailObatRacikan.getValueAt(i, 5).toString(), tbDetailObatRacikan.getValueAt(i, 1).toString(), tbDetailObatRacikan.getValueAt(i, 1).toString(),
                                                    tbDetailObatRacikan.getValueAt(i, 6).toString()
                                                });
                    ...
                    if (sukses == true) {
                        if (JADIKANPIUTANGAPOTEKBPJS.equals("yes")) {
                            ...
                            Sequel.menyimpantf2("tampjurnal", "'" + Sequel.cariIsi("select set_akun.Piutang_Obat from set_akun") + "','PIUTANG OBAT','" + ttl + "','0'", "Rekening");
                            Sequel.menyimpantf2("tampjurnal", "'" + Sequel.cariIsi("select set_akun.Kontra_Piutang_Obat from set_akun") + "','PERSEDIAAN','0','" + ttl + "'", "Rekening");
    ...
    private void btnDetailSEP1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDetailSEP1ActionPerformed
        this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
        ApotekBPJSKunjunganSEP detailSEP = new ApotekBPJSKunjunganSEP(null, true);
        detailSEP.NoSEP.setText(NoSEP.getText());
        detailSEP.setSize(internalFrame1.getWidth() - 20, internalFrame1.getHeight() - 20);
        detailSEP.setLocationRelativeTo(internalFrame1);
        detailSEP.setVisible(true);
        this.setCursor(Cursor.getDefaultCursor());
    }//GEN-LAST:event_btnDetailSEP1ActionPerformed

    private void btnSEPResumeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSEPResumeActionPerformed
        String statusRawat = Sequel.cariIsi("select reg_periksa.status_lanjut from reg_periksa where reg_periksa.no_rawat='" + TNoRW.getText() + "'");

        if (statusRawat.equals("Ralan")) {
            String nomorsep = Sequel.cariIsi("select bridging_sep.no_sep from bridging_sep where bridging_sep.no_rawat='" + TNoRW.getText() + "' and bridging_sep.jnspelayanan='2'");
            kodedokterregis = Sequel.cariIsi("select reg_periksa.kd_dokter from reg_periksa where reg_periksa.no_rawat='" + TNoRW.getText() + "'");
            namadokterregis = Sequel.cariIsi("select dokter.nm_dokter from dokter where dokter.kd_dokter='" + kodedokterregis + "'");
            ...
            if (Sequel.cariInteger("select count(pemeriksaan_ralan.no_rawat) from pemeriksaan_ralan where pemeriksaan_ralan.no_rawat='" + TNoRW.getText() + "' and pemeriksaan_ralan.nip='" + kodedokterregis + "'") > 0) {
                param.put("diagnosautama", Sequel.cariIsi("select pemeriksaan_ralan.penilaian from pemeriksaan_ralan where pemeriksaan_ralan.nip='" + kodedokterregis + "' and pemeriksaan_ralan.no_rawat='" + TNoRW.getText() + "'"));
                param.put("uraian", Sequel.cariIsi("select pemeriksaan_ralan.instruksi from pemeriksaan_ralan where pemeriksaan_ralan.nip='" + kodedokterregis + "' and pemeriksaan_ralan.no_rawat='" + TNoRW.getText() + "'"));
            } else if (Sequel.cariInteger("select count(penilaian_medis_ralan.no_rawat) from penilaian_medis_ralan where penilaian_medis_ralan.no_rawat='" + TNoRW.getText() + "' and penilaian_medis_ralan.kd_dokter='" + kodedokterregis + "'") > 0) {
                param.put("diagnosautama", Sequel.cariIsi("select penilaian_medis_ralan.diagnosis from penilaian_medis_ralan where penilaian_medis_ralan.no_rawat='" + TNoRW.getText() + "' and penilaian_medis_ralan.kd_dokter='" + kodedokterregis + "'"));
                param.put("uraian", Sequel.cariIsi("select penilaian_medis_ralan.konsulrujuk from penilaian_medis_ralan where penilaian_medis_ralan.no_rawat='" + TNoRW.getText() + "' and penilaian_medis_ralan.kd_dokter='" + kodedokterregis + "'"));
            } else if (Sequel.cariInteger("select count(penilaian_medis_ralan_tht.no_rawat) from penilaian_medis_ralan_tht where penilaian_medis_ralan_tht.no_rawat='" + TNoRW.getText() + "' and penilaian_medis_ralan_tht.kd_dokter='" + kodedokterregis + "'") > 0) {
                param.put("diagnosautama", Sequel.cariIsi("select penilaian_medis_ralan_tht.diagnosis from penilaian_medis_ralan_tht where penilaian_medis_ralan_tht.no_rawat='" + TNoRW.getText() + "' and penilaian_medis_ralan_tht.kd_dokter='" + kodedokterregis + "'"));
                param.put("uraian", Sequel.cariIsi("select penilaian_medis_ralan_tht.konsulrujuk from penilaian_medis_ralan_tht where penilaian_medis_ralan_tht.no_rawat='" + TNoRW.getText() + "' and penilaian_medis_ralan_tht.kd_dokter='" + kodedokterregis + "'"));
            } else if (Sequel.cariInteger("select count(penilaian_medis_ralan_psikiatrik.no_rawat) from penilaian_medis_ralan_psikiatrik where penilaian_medis_ralan_psikiatrik.no_rawat='" + TNoRW.getText() + "' and penilaian_medis_ralan_psikiatrik.kd_dokter='" + kodedokterregis + "'") > 0) {
                param.put("diagnosautama", Sequel.cariIsi("select penilaian_medis_ralan_psikiatrik.diagnosis1 from penilaian_medis_ralan_psikiatrik where penilaian_medis_ralan_psikiatrik.no_rawat='" + TNoRW.getText() + "' and penilaian_medis_ralan_psikiatrik.kd_dokter='" + kodedokterregis + "'"));
                param.put("uraian", Sequel.cariIsi("select penilaian_medis_ralan_psikiatrik.tata from penilaian_medis_ralan_psikiatrik where penilaian_medis_ralan_psikiatrik.no_rawat='" + TNoRW.getText() + "' and penilaian_medis_ralan_psikiatrik.kd_dokter='" + kodedokterregis + "'"));
            }

            StringBuilder tindakandr = new StringBuilder();
            try {
                PreparedStatement pstindakan = koneksi.prepareStatement("SELECT jns_perawatan.nm_perawatan FROM rawat_jl_dr INNER JOIN jns_perawatan ON rawat_jl_dr.kd_jenis_prw = jns_perawatan.kd_jenis_prw WHERE rawat_jl_dr.no_rawat=? ORDER BY rawat_jl_dr.tgl_perawatan, rawat_jl_dr.jam_rawat");
                pstindakan.setString(1, TNoRW.getText());
                ResultSet rstindakan = pstindakan.executeQuery();
                while (rstindakan.next()) {
                    tindakandr.append(rstindakan.getString(1)).append("\n");
                }
                rstindakan.close();
                pstindakan.close();
            } catch (Exception e) {
            ...
            param.put("prosedurutama", tindakandr.toString());
            ...
            String nomorsep = Sequel.cariIsi("select bridging_sep.no_sep from bridging_sep where bridging_sep.jnspelayanan='1' and bridging_sep.no_rawat='" + TNoRW.getText() + "'");
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            Map<String, Object> param = new HashMap<>();
            param.put("namars", akses.getnamars());
            param.put("alamatrs", akses.getalamatrs());
    ...
    private void btnHasilLabActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHasilLabActionPerformed
        ...
        hasillab.HasilLabPDFKlaimBPJS(TNoRW.getText(), TNoRM.getText());
        hasillab.dispose();
        this.setCursor(Cursor.getDefaultCursor());
        cekDanUbahTeksTombol();
    }//GEN-LAST:event_btnHasilLabActionPerformed

    private void cekDanUbahTeksTombol() {
        try {
            String rawat = TNoRW.getText();
            if (!rawat.trim().equals("")) {

                Color hijauTua = new Color(0, 120, 70); // hijau adem
                Color merah = new Color(200, 0, 0); // merah agak soft

                // Cek SEP
                if (Sequel.cariInteger("select count(no_rawat) from bridging_sep where no_rawat='" + rawat + "'") > 0) {
                    btnSEPResume.setText("Ada");
                    btnSEPResume.setForeground(hijauTua);
                } else {
                    btnSEPResume.setText("Tidak Ada");
                    btnSEPResume.setForeground(merah);
                }

                // Cek Hasil Lab
                if (Sequel.cariInteger("select count(no_rawat) from periksa_lab where no_rawat='" + rawat + "'") > 0) {
                    btnHasilLab.setText("Ada");
                    btnHasilLab.setForeground(hijauTua);
                } else {
                    btnHasilLab.setText("Tidak Ada");
                    btnHasilLab.setForeground(merah);
                }
            }
        } catch (Exception e) {
            System.out.println("Error checking data: " + e);
        }
    }
    ...
    private javax.swing.JButton btnDetailSEP1;
    private javax.swing.JButton btnHasilLab;
    private javax.swing.JButton btnSEPResume;
    private widget.ComboBox cmbDtk;
    private widget.ComboBox cmbJam;
    private widget.ComboBox cmbMnt;
    private widget.Label icon;
