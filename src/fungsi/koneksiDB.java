...
public class koneksiDB {
    ...
    public static String IDORGBPJSSATUSEHAT() {
     ...
     //    tambahan kholis untuk smartclaim
    public static String URLAPIBPJSSMARTCLAIM() {
        try ( FileInputStream fis = new FileInputStream("setting/database.xml")) {
            prop.loadFromXML(fis);
            var = prop.getProperty("URLAPIBPJSSMARTCLAIM");
        } catch (Exception e) {
            var = "";
        }
        return var;
    ...
    public static String KODEPPKAPLICAREBPJS() {
        try ( FileInputStream fis = new FileInputStream("setting/database.xml")) {
            prop.loadFromXML(fis);
            var = EnkripsiAES.decrypt(prop.getProperty("KODEPPKAPLICAREBPJS"));
        } catch (Exception e) {
            var = "";
        }
        return var;
