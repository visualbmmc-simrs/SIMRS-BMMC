                ...
                while (rs.next()) {
                    ...
                    try {
                        ...
                        if (rspermintaan.next()) {
                            ...
                            param.put("tanggalpermintaan", rspermintaan.getString("tgl_permintaan"));
                            param.put("jampermintaan", rspermintaan.getString("jam_permintaan"));
                            Valid.MyReportPDFKlaim("rptPeriksaLabPermintaan.jasper", "report", "4PERIKSALAB", param, "hasilkompilasifarmasi", NomorRawat.replaceAll("/", "") + urutan);
                        } else {
                            Valid.MyReportPDFKlaim("rptPeriksaLab.jasper", "report", "4PERIKSALAB", param, "hasilkompilasifarmasi", NomorRawat.replaceAll("/", "") + "-" + urutan);
                        }
                    } catch (Exception e) {
                        System.out.println("Notif : " + e);
                    } finally {
