...
private void BtnEditKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnEditKeyPressed
    ...
    */
    ...
    private widget.TextBox txtCariMenu;
    private widget.Button btnCariMenu;
    ...
    private void isMenu(){
     ...
     // === TAMBAHAN METHOD UNTUK FILTER MENU ===
    private void filterMenu() {
        String keyword = txtCariMenu.getText().trim().toLowerCase();
        java.awt.Component[] components = FormMenu.getComponents();
        
        for (java.awt.Component comp : components) {
            if (comp instanceof widget.Button) {
    ...
    private void initSearchMenu() {
        // Buat panel pencarian
        searchPanel = new javax.swing.JPanel(new java.awt.FlowLayout(java.awt.FlowLayout.LEFT, 5, 5));
        searchPanel.setBackground(new java.awt.Color(255, 255, 255));
        searchPanel.setPreferredSize(new java.awt.Dimension(200, 35));
        
        txtCariMenu = new widget.TextBox();
        txtCariMenu.setPreferredSize(new java.awt.Dimension(140, 25));
        txtCariMenu.setToolTipText("Cari menu...");
        ...
        btnCariMenu = new widget.Button();
        btnCariMenu.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/Search-16x16.png")));
        btnCariMenu.setPreferredSize(new java.awt.Dimension(25, 25));
        btnCariMenu.setToolTipText("Cari");
        ...
        searchPanel.add(txtCariMenu);
        searchPanel.add(btnCariMenu);
        
        PanelAccor.remove(ScrollMenu);
        
        PanelAccor.add(searchPanel, java.awt.BorderLayout.NORTH);
        PanelAccor.add(ScrollMenu, java.awt.BorderLayout.CENTER);
        
        PanelAccor.revalidate();
        PanelAccor.repaint();
    }//Tambahan kholis search
